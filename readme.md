...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&duration=3000&pause=900&color=14B8A6&center=true&vCenter=true&width=850&lines=Software+Engineer+%7C+GenAI+Engineer;Building+AI-integrated+backend+systems;RAG+%7C+Spring+Boot+%7C+FastAPI+%7C+Next.js;Retrieval%2C+embeddings%2C+LLM+inference+%26+scalable+systems" alt="Typing SVG" />
</a>

📍 Mumbai, India &nbsp;|&nbsp; 🎓 B.E. Information Technology, VESIT (2026) &nbsp;|&nbsp; CGPA 8.61

[![Open to Work](https://img.shields.io/badge/Open%20to%20Work-14B8A6?style=flat&logo=briefcase&logoColor=white)](https://www.linkedin.com/in/arjun-silwal-a1a3a5309/)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-14B8A6?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/arjun-silwal-a1a3a5309/)
[![Email](https://img.shields.io/badge/Email-14B8A6?style=flat&logo=gmail&logoColor=white)](mailto:singharjun222005@gmail.com)
...
```typescript
const arjun = {
  title: "Software Engineer | GenAI Engineer",
  status: "Fresh Graduate — B.E. Information Technology, VESIT, 2026",
  stack: {
    languages: ["Java", "Python", "JavaScript", "TypeScript"],
    frontend: ["Next.js", "React", "Tailwind CSS"],
    backend: ["Spring Boot", "FastAPI"],
    databases: ["Supabase", "PostgreSQL"],
    ai: ["Gemini 2.5", "FAISS", "Ollama"],
    cloud: ["Vercel"]
  },
  projects: ["PrintDrop", "Placement Intelligence Platform", "KanunAI", "WhatsApp Notification Router"],
  certifications: ["HackerRank Software Engineer — Role Certification"],
  currentFocus: ["DSA (Java)", "Distributed Systems fundamentals", "Spring Boot depth"],
  openTo: ["Software Engineering", "SDE", "GenAI Engineering"]
};
```
...
### 🖨️ [PrintDrop](https://github.com/YOUR-USERNAME/printdrop)
...
### ⚖️ [KanunAI](https://github.com/YOUR-USERNAME/KanunAi) — AI-Powered Virtual Legal Assistant
...
- Finalist, Nomura KakushIN 9 Hackathon — team project on AI-assisted coordination logistics (AWS Bedrock)

---

## 📚 Currently Exploring

- Distributed systems fundamentals and backend scalability patterns
